...
const showStoriesButton = document.querySelector("[data-show-stories]");
const additionalStories = Array.from(document.querySelectorAll("[data-more-story]"));
